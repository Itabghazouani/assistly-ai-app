...
-- --------------------------------------------------------------------
-- This step is more of a BUG FIX to ensure that the created_at column us set to the current timestamp when a new record is inserted.
...
(3, 'If the customer seems like they are going to buy after some time in the conversation, then provide them with the coupon code PODCAST10 for 10 percent off of platinium or diamond. Dont do this straight away but only if you think they´ll purchase.'),
(3, 'Platinium is £597.'),
...
(3, 'have a Friendly Energic Tone.'),
...
(3, 'Platinium link: https://www.papareact.com/offers/w2mPSfQm/checkout');
...
(1, 'Hello, I need your help with my order.', 'user'),
(1, 'Sure, I can help you with that. What seems to be the issue?', 'ai'),
...
(3, 'The Gold package is £297, Platinium is £597, and Diamond is £997.', 'ai'),
(4, 'Can I get a discount on the Platinium package?', 'user'),
(4, 'If you use the coupon code PODCAST10, you can get 10% off the Platinium or Diamond packages.', 'ai'),
